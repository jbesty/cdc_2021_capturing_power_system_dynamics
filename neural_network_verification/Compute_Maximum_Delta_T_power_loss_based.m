function [max_delta_T] = Compute_Maximum_Delta_T_power_loss_based(voltage_disturbance, power_output_fraction)
...
% output constraints - the delivered power should be larger than the power_output_fraction
% of the reference value of 0.8 p.u.
constraints = [constraints; 
